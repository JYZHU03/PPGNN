...
class LVConv(MessagePassing):
    ...
    def __init__(
        ...
        if self.learn_dt:
            self.dt_param = nn.Parameter(torch.tensor(float(dt)))
    ...
    def _dt(self) -> torch.Tensor:
        ...
        # dt_buffer is a tensor buffer; ensure tensor type for autograd graph consistency
...
def main(argv: Iterable[str] | None = None):
    ...
    parser.add_argument("--learn_dt", type=int, default=1, help="1 to make dt learnable, 0 to keep fixed")
    ...
    for dataset_name in args.dataset:
        ...
        for model_name in args.models:
            ...
            if model_name == "ppgnn":
                ...
                if args.learn_dt is not None:
                    model_params["learn_dt"] = int(args.learn_dt)
